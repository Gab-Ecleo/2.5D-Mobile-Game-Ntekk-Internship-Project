...
public class Barrier : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        currentPlayerStats.barrierUpgrade = initialPlayerStats.barrierUpgrade;
    ...
    {
        currentPlayerStats.barrierUpgrade++;
        switch (currentPlayerStats.barrierUpgrade)
        {
            //Upgrade Tree
            case 1:
                // Add durability to the barrier using the modifier
                currentPlayerStats.barrierDurability += durabModif;
